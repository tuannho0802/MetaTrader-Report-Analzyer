...
export const translations = {
  en: {
    ...
    monteCarlo: {
      ...
      sampleSizeNote: "Simulation results are proportional to the number of trades. Increasing sample size will increase both profit and drawdown range.",
      chartNoteProfit: "X-axis: Total Profit. Y-axis: Number of simulations. Green bars represent profitable outcomes.",
      chartNoteDrawdown: "X-axis: Max Drawdown. Y-axis: Number of simulations. Red bars represent risk depth.",
      tooltipRange: "Range",
      tooltipFrequency: "Frequency",
      tooltipPercent: "Percent",
      helpMeanProfit: "Average outcome across all simulated runs.",
      helpMedianProfit: "The middle value of all outcomes. 50% of simulations are above this, 50% below.",
      helpStdDev: "Measures profit dispersion. Higher values mean higher volatility and risk.",
      helpWorstProfit: "The worst simulated outcome out of all runs.",
      helpBestProfit: "The best simulated outcome out of all runs.",
      helpConfidence95: "With 95% probability, the actual outcome is expected to fall within this range.",
      helpMeanDrawdown: "Average maximum peak-to-trough decline observed per run.",
      helpWorstDrawdown: "The single largest drawdown observed across all simulations.",
      helpProbProfit: "Probability of achieving a net profit > 0 based on the simulation set.",
      helpRiskOfRuin: "Probability that peak drawdown exceeds your account balance, leading to total capital loss.",
    },
  },
  vi: {
    common: {
    ...
    monteCarlo: {
      ...
      profitDistributionDesc: "Histogram tổng lợi nhuận qua các lần mô phỏng",
      drawdownDistribution: "Phân phối Drawdown tối đa",
      drawdownDistributionDesc: "Histogram drawdown đỉnh quan sát được mỗi lần chạy",
      ...
      sampleSizeNote: "Kết quả mô phỏng tỉ lệ thuận với số lệnh mỗi lần chạy. Tăng số lệnh sẽ tăng biên độ lợi nhuận và drawdown.",
      chartNoteProfit: "Trục X: Tổng lợi nhuận. Trục Y: Số lần mô phỏng. Cột xanh biểu thị các kịch bản có lãi.",
      chartNoteDrawdown: "Trục X: Drawdown tối đa. Trục Y: Số lần mô phỏng. Cột đỏ biểu thị mức độ rủi ro.",
      tooltipRange: "Khoảng giá trị",
      tooltipFrequency: "Tần suất",
      tooltipPercent: "Phần trăm",
      helpMeanProfit: "Kết quả trung bình cộng của tất cả các lần mô phỏng.",
      helpMedianProfit: "Giá trị nằm ở giữa tập dữ liệu. 50% kịch bản cao hơn và 50% kịch bản thấp hơn giá trị này.",
      helpStdDev: "Đo lường mức độ phân tán của lợi nhuận so với trung bình. Càng cao thì rủi ro và biến động càng lớn.",
      helpWorstProfit: "Kết quả tệ nhất trong toàn bộ các lần mô phỏng.",
      helpBestProfit: "Kết quả tốt nhất trong toàn bộ các lần mô phỏng.",
      helpConfidence95: "Với 95% khả năng, lợi nhuận thực tế sẽ nằm trong khoảng này.",
      helpMeanDrawdown: "Mức sụt giảm vốn tối đa trung bình quan sát được mỗi lần chạy.",
      helpWorstDrawdown: "Mức sụt giảm vốn lớn nhất từng xảy ra trong toàn bộ các kịch bản.",
      helpProbProfit: "Xác suất đạt được lợi nhuận ròng > 0 dựa trên tập mô phỏng.",
      helpRiskOfRuin: "Xác suất mà mức sụt giảm vốn (drawdown) vượt quá số dư tài khoản, dẫn đến cháy tài khoản.",
    }
  }
};
